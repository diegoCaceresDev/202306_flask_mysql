...
from flask_app.utils.expresiones_regulares import EMAIL_REGEX, PASSWORD_REGEX
...
class Usuario:
    ...
    def validar(cls, formulario):
        ...
        if not PASSWORD_REGEX.match(formulario['password']):
            errores.append(
                "La contraseña debe tener una letra mayuscula, un numero y una longitud minima de 8 digitos"
            )
